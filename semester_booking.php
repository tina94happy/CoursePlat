...
<script type="text/javascript">
    var iframe = document.getElementById("common_table");
...
<body class="contact-page">
                ...
                <div class="breadcrumbs">
                    <ul class="flex flex-wrap align-items-center p-0 m-0">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-vector-pen" viewBox="0 0 16 16">
                          ...
                          <a href="book_room.php"> <button type="button" class="btn btn-warning" style="margin-left: 10px;">返回</button></a>  
                    </ul>
                </div><!-- .breadcrumbs -->
    ...
    <!-- end about -->
    <!-- 按鈕區 -->
    <div style="position:relative;left:22%;margin-top: 15px;">
       ...
       <form action="" style="position: relative;top: 13px;">
        請選擇日期: 
            <select name="cars" id="classroom">
              <option value="SL220">星期一</option>
           
              <option value="SL221">星期二</option>
              <option value="SL222">星期三</option>
              <option value="MD1001">星期四</option>  
               <option value="LM101">星期五</option>
               <option value="LM102">星期六</option>
               <option value="LM102">星期日</option>
            </select>


            請選擇教室: 
            <select name="cars" id="classroom">
                <option value="" selected>請選擇教室</option>
              <option value="SL220">SL202</option>
           
              <option value="SL221">SL203</option>
              <option value="SL222">SL204</option>
              <option value="MD1001">SL205</option>  
               <option value="LM101">LM101</option>
               <option value="LM102">LM102</option>
               <option value="LM102">LM103</option>
            </select>
            <input type="button" value="送出" style="margin-left:200px">
            <br><br>
    ...
    <!-- table區 -->
    <iframe id="common_table"  src='n\新資料夾\index_semester.html' width="100%" marginwidth="0" marginheight="0" scrolling="No" frameborder="0" ></iframe>

    <!-- <div style="position: relative;left:25%;">預約使用空間須知:</div> -->
