...
<body class="contact-page">
    ...
    <div class="container" style="margin-right: auto;margin-left: auto; margin-top: 15px;">
		...
		請選擇日期: <input type="date"style="margin:6px;" ><br>
		請選擇用途: <input type="text"><input type="button" value="送出">
	</div>
    <!-- table區 -->
    <iframe src="n\新資料夾\index.php" scrolling="no" id="common_table" frameborder="0" width="100%" height="1000px" ></iframe>
  <!-- <div style="position: relative;left:22%;">預約使用空間須知:</div> -->
