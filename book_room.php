...
<body class="contact-page">
    ...
    <!-- end about -->
       ...
       <div class="content">
          ...
          <a href="common_booking.php" style="margin-right: 10px; text-decoration:none;"> <div class="card">
          ...
          <!-- end card -->
          <!-- card -->
          <a href="semester_booking.php" style="margin-right: 10px; text-decoration:none;"> <div class="card">
